...
[CreateAssetMenu(fileName = "CarAIMovementParametersHolderSO", menuName = "Office_Driver/CarAIMovementParametersHolderSO", order = 0)]
public class CarAIMovementParametersHolderSO : ScriptableObject {
