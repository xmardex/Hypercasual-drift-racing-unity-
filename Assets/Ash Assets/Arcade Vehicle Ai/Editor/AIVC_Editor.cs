...
namespace ArcadeVP
{
    [CustomEditor(typeof(ArcadeAiVehicleController))]
    public class AIVC_Editor : Editor
    {
        private const string DiscordUrl = "https://discord.com/invite/zD6AhYcYdG";
        private const string TutorilUrl = "https://youtu.be/Z_sxxI5e_1o";
        private const string DocumentationUrl = "/Ash Assets/Arcade Vehicle Ai/Documentation/Documentation.pdf";
        private const string RateUrl = "https://assetstore.unity.com/packages/tools/ai/arcade-vehicle-ai-220740#reviews";
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(10f);
            GUILayout.Label("Arcade Vehicle Ai", headerStyle);
            GUILayout.Space(10f);
